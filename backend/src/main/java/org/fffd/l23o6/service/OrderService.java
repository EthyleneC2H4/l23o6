...
public interface OrderService {
    ...
    void payOrder(Long id, String username);
    void setMethod(Long id ,String method);

    // Todo(finished): create a function to update the credits
    void updateCredits(String username);
}
