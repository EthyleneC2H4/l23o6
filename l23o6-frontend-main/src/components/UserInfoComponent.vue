...
<template>
  <div style="display: flex; flex-direction: column">
    ...
    <el-form ref="ruleFormRef" :model="form" :rules="rules" label-width="30%" class="demo-ruleForm" label-position="right"
      ...
      <el-form-item label="里程积分" prop="idn">
        <el-input v-model="user.MileagePoints" type="text" style="width: 25vh" :disabled="!edit" />
      </el-form-item>

      <el-form-item label="抵扣积分" prop="phone">
        <el-input v-model="user.DiscountPoints" style="width: 25vh" :disabled="!edit" />
      </el-form-item>
